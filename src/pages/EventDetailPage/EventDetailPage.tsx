  ...
  return (
    <StyledEventDetailPage>
            ...
            <div className="flexcontainer">
              ...
              <p className="div-3">
                <span className="span">
                  ...
                  ვამაგრებდით დიდ ყუთს და ყველაზე მძიმე წიგნებს ვალაგებდით.
                  გვიხაროდა, ღიმილს გვგვრიდა, ბავშვობაში გვაბრუნებდა.
                  მისრიალებდა ციგა გაუკვალავ თოვლში და ნელ-ნელა ემატებოდნენ
                  ბავშვები მის ირგვლივ... არასდროს დაგვავიწყდება ეს
                  თავგადასავალი...
                  <br />
                </span>
              </p>
              <p className="div-3">
                <span className="span">
                  მეორე სურათზე კი ყველაზე პატარა წევრის ოცნებები წერია: &#34;მე
                  რომ ბევრი ფული მქონდეს &#34;მთიელ წიგნებს&#34; ვუყიდდი დიდ
                  მანქანას, რათა ადვილად აუტანონ მთაში ბავშვებს წიგნები&#34; სულ
                  თავისით მოიფიქრა და უსაყვარლესმა მასწავლებელმა სიტყვა-სიტყვით,
                  უცვლელად, ჩაიწერა... ჰოდა ასეთი ოცნება გვაბედნიერებს და
                  გვარწმუნებს, რომ სწორ საქმეს მივყვებით და ეს ყველაფერი დიდხანს
                  გაგრძელდება... ჩვენ შემდეგაც კი ...
                </span>
              </p>
            </div>
          </div>
      ...
      <Footer
        ...
        override={<Instagramicon1 className="instagramicon-1" />}
        platform="web"
        logo=""
      />
    </StyledEventDetailPage>
