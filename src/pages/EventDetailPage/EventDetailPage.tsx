  ...
  return (
    <Layout>
      <SC.Container>
          ...
          <SC.Article>
            <SC.Heading>სათაური</SC.Heading>
            <SC.Paragraph>პარაგრაფი</SC.Paragraph>
            <SC.SubHeading>ქვესათაური</SC.SubHeading>
            <SC.Paragraph>
            ...
            <SC.Paragraph>
              ...
              გვიხაროდა, ღიმილს გვგვრიდა, ბავშვობაში გვაბრუნებდა. მისრიალებდა
              ციგა გაუკვალავ თოვლში და ნელ-ნელა ემატებოდნენ ბავშვები მის
              ირგვლივ... არასდროს დაგვავიწყდება ეს თავგადასავალი...
              <br />
            </SC.Paragraph>
            <SC.Paragraph>
              ...
              ჩაიწერა... ჰოდა ასეთი ოცნება გვაბედნიერებს და გვარწმუნებს, რომ
              სწორ საქმეს მივყვებით და ეს ყველაფერი დიდხანს გაგრძელდება... ჩვენ
              შემდეგაც კი ...
            </SC.Paragraph>
            <SC.SubHeading>ქვესათაური</SC.SubHeading>
            <SC.Paragraph>
