  ...
  return (
    <Layout>
      <StyledAboutPage className="about-page">
        <AboutSection className="design-component-instance-node-2" />
        <Divider />
            ...
            <div className="flexcontainer">
              <p className="text-i">
                <span className="span">
                  ...
                  სვანეთში, ლეჩხუმსა და ახმეტაში მცხოვრებ 700–მდე ბავშვს და
                  30–მდე მცირეკონტინგენტიან სკოლას თანამედროვე გამოცემები
                  გადასცეს.
                  <br />
                </span>
              </p>
              ...
              <p className="text-i">
                <span className="span">
                  „ბავშვები მეკითხებოდნენ, მართლა რაც გვინდა იმ წიგნს
                  მოგვცემენო, თანაც პირადადო? ვპასუხობდი, მგონი ასე
                  იქნება–მეთქი. დაუჯერებელია ეს ამბავი, დიდი მადლობა
                  წიგნებისთვის, ძალიან გაუხარდათ ბავშვებს...“
                  <br />
                </span>
              </p>
              <p className="text-i">
                <span className="span">
                  ...
                  განხილვის მოწერა რომ დამაგვიანდა. მადლობა, ეს წიგნი რომ
                  ჩემამდე მოვიდა... უზომოდ მომეწონა... თითქოს კითხვის დროს იქ
                  ვიდექი და სიუჟეტი ჩემს თვალწინ ვითარდებოდა... თქვენი
                  დამსახურებით კიდევ ერთ საუკეთესო დეტექტივს გავეცანი“
                  <br />
                </span>
              </p>
              <p className="text-i">
                <span className="span">
                  ...
                  დანებება აღარ მინდოდა, მადლობა“ ბავშვების ემოციები
                  გრძელვადიანი საქმიანობისთვის კარგ მოტივატორად იქცა.{" "}
                </span>
              </p>
            </div>
          </div>
